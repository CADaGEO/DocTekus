...
(setq taillecroix (* 0.005 echelle))
...
(cond
	((< (cadr(nth 0 listptInter)) (car(nth 1 listptInter)))
...
;Fonction qui dessin les traits de rappel verticaux
...
;Fonction qui dessine les croix de carroyage
